                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-3'>
                            <div className='relative'>
                                ...
                                <div className='mb-5 lg:mb-0 text-white'>
                                    ...
                                    <p className='flex items-start leading-5 mt-1'><MapPinIcon className='size-10 mr-2' /> Kheyti Tech Pvt. Ltd., Plot No. 200, 2nd Cross, Rocktown Colony, Mansoorabad, Hyderabad, Telangana, 500068</p>
                                </div>
                                ...
                                <div className='lg:mt-24 grid lg:grid-cols-2 gap-8'>
                                    <div>
                                        <ul>
                                            ...
                                            <li><Link href="#" className='text-white'>Our Solutions</Link></li>
                                        </ul>
                                    </div>
                                    <div>
                                        <ul>
                                            <li><Link href="#" className='text-white'>Partners and Supports</Link></li>
                                            <li><Link href="#" className='text-white'>Join Us</Link></li>
                            ...
                            <div>
                                <h6 className='text-white font-semibold text-xl'>Subscribe to our newsletter</h6>
                                <div>
                                ...
                                <div className='mt-5 mb-10 lg:mb-0 text-white'>
                                    <h6 className='font-semibold text-lg'> Join our community</h6>
